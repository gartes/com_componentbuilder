...
class Get
{
	...
	/**
	 *  Заполнители пользовательских скриптов - мы используем (xxx),
	 *  чтобы избежать обнаружения, это должно быть (***)
	 *
	 ...
	 *
	 * 	/////////////////////////////// изменение существующего пользовательского кода /////////
	 ...
	 *
	 *
	 *  Заполнители пользовательских скриптов - мы используем (==),
	 *  чтобы избежать обнаружения, это должно быть (-)
	 *
	 *  The custom script placeholders - we use the (==)
	 *  to avoid detection it should be (--)
	 * 	###################################--->  HTML  <---#####################################
	 * 
	 ...
	 * 
	 * 	////////23 - идентификатор кода в системе, не меняйте его!!!!!!!!!!!!!!!!!!!!!!!!!!
