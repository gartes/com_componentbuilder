...
/**
 * Vm_product_comparisons component helper.
 */
abstract class Vm_product_comparisonsHelper
{
    /**
    * Загрузите XML-манифест компонента.
    * Load the Component xml manifest.
    * @since 3.9
    */
	public static function manifest()
	{
		$manifestUrl = JPATH_ADMINISTRATOR."/components/com_vm_product_comparisons/vm_product_comparisons.xml";
		return simplexml_load_file($manifestUrl);
	}

    /**
    * Joomla версия объекта
    ...
    */
	...
	{
		// get params
		$params	= JComponentHelper::getParams('com_vm_product_comparisons');
	...
	/**
	 *	Может использоваться для создания справочных URL.
    ...
    */
	public static function addSubmenu($submenu)
	{
		...
		JHtmlSidebar::addEntry(JText::_('COM_VM_PRODUCT_COMPARISONS_SUBMENU_DASHBOARD'), 'index.php?option=com_vm_product_comparisons&view=vm_product_comparisons', $submenu === 'vm_product_comparisons');
		JHtmlSidebar::addEntry(JText::_('COM_VM_PRODUCT_COMPARISONS_SUBMENU_COPMARE_LIST'), 'index.php?option=com_vm_product_comparisons&view=copmare_list', $submenu === 'copmare_list');
	}

	/**
	 * Готовит документ XML
	 * Prepares the xml document
	 * @since 3.9
	 */
	public static function xls($rows,$fileName = null,$title = null,$subjectTab = null,$creator = 'Gstes Co.',$description = null,$category = null,$keywords = null,$modified = null)
	{
		// set the user
		$user = JFactory::getUser();
	 ...
	 *
	 * @return  object|bool string/int/float
	 * @since 3.9
	 *
	 */
	public static function getVar($table, $where = null, $whereString = 'user', $what = 'id', $operator = '=', $main = 'vm_product_comparisons')
	{
		if(!$where)
		{
	 ...
	 *
	 */
	public static function getVars($table, $where = null, $whereString = 'user', $what = 'id', $operator = 'IN', $main = 'vm_product_comparisons', $unique = true)
	{
		if(!$where)
		{
			$where = JFactory::getUser()->id;
	...
	public static function isPublished($id,$type)
	{
		...
		$query->from('#__vm_product_comparisons_'.$type.' AS a');
	...
	* 
	**/
	public static function getActions($view, &$record = null, $views = null, $target = null, $component = 'vm_product_comparisons', $user = 'null')
	{
	...
	**/
	public static function getModel($name, $path = JPATH_COMPONENT_ADMINISTRATOR, $Component = 'Vm_product_comparisons', $config = array())
	{
		// fix the name
	...
	*/
	public static function setAsset($id, $table, $inherit = true)
	{
		...
		$parent->loadByName('com_vm_product_comparisons');
		
		$parentId = $parent->id;
		$name     = 'com_vm_product_comparisons.'.$table.'.'.$id;
		$title    = '';
		...
		else
		{
			...
			$rules = self::getDefaultAssetRules('com_vm_product_comparisons', $table, $inherit);
			...
			else
			{
				...
				return JFactory::getDbo()->updateObject('#__vm_product_comparisons_'.$table, $object, 'id');
			}
		}
		return false;
	}
