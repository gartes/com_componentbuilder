...
/**
 * Vm_product_comparisons Component Controller
 */
class Vm_product_comparisonsController extends JControllerLegacy
{
	...
	function display($cachable = false, $urlparams = false)
	{
		...
		if($isEdit)
		{
			if ($layout == 'edit' && !$this->checkEditId('com_vm_product_comparisons.edit.'.$view, $id))
			{
				...
				else
				{
					...
					$this->setRedirect(JRoute::_('index.php?option=com_vm_product_comparisons&view=', false));
				}
				return false;
			}
		}
		...
		if (Vm_product_comparisonsHelper::checkArray($urlparams))
		{
			$safeurlparams = Vm_product_comparisonsHelper::mergeArrays(array($urlparams, $safeurlparams));
		}
