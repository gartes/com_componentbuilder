...
# Joomla Component ->Libs & Helpers -> Add PHP (helper_site Class) *
         /**
	 * Загрузка css Стиля
	 * @param         $fileUrl
	 * @param   bool  $asStyle - Загружать в head || как файл 
	 * @param   bool  $asMin   - минимизация (пока не работает)
	 * @since 3.9 
	 */
	public static function loadCss( $fileUrl , $asStyle = false  , $asMin = false ){
		$doc = JFactory::getDocument();
		
		if( $asStyle )
		{
			$filePACH = JPATH_ROOT . $fileUrl ;
			$css = file_get_contents( $filePACH );
			$doc->addStyleDeclaration( $css );
		}else{
			$doc->addStyleSheet( $fileUrl );
		}#END IF
/***[REPLACED$$$$]***//*33*/
		// sssssssaaaaaaadddddddXXXXXXXXXXXXXXXXXXXXXXXXXgggggg
		// echo 'Vm_product_comparisonsHelper';
/***[/REPLACED$$$$]***/
	}#END FUNCTION
	...
	**/
	public static function getModel($name, $path = JPATH_COMPONENT_SITE, $Component = 'Vm_product_comparisons', $config = array())
	{
		// fix the name
