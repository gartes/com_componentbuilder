<?php
	/**
	 * Кнопка перехода на страницу стравнения
     *
     * @license
     * @copyright
     * @since 3.9
	...
	?>
<div name="splash-button" id="comparison" class="comparison-m label <?=(!$allProductCount?'empty':null)?>">
    <a <?=(!$allProductCount?'href="#"':$linkComparisons)?>  title="Сравнение" class="hub-i-link <?=$a_class?> hub-i-comparison-link sprite-side whitelink">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="none"
            ...
            <path fill-rule="evenodd" clip-rule="evenodd"
                  ...
                  fill="<?= ($allProductCount?'#f8d71b':'#d2d2d2')?>"/>
        </svg>
    </a>
</div>
